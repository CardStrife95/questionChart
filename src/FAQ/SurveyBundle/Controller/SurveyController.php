...
class SurveyController extends Controller
{
    ...
    {
        $survey = new Survey();
        $form = $this->createForm('FAQ\SurveyBundle\Form\SurveyType', $survey);
    ...
    public function showAction(Survey $survey)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $questions = $em->getRepository('FAQSurveyBundle:Question')->findBy(array("survey"=>$survey));
    ...
    {
        $deleteForm = $this->createDeleteForm($survey);
        $editForm = $this->createForm('FAQ\SurveyBundle\Form\SurveyType', $survey);
